/*
 * mips-linux-gcc -I/home/rhk/workspace/trunk/staging/include/ -o sysfs_driver_sd sysfs_driver_sd.c /home/rhk/workspace/trunk/staging/lib/libsysfs.a
 *
 */
...
int main(int argc, char *argv[])
{
	...
	sf_driver = sysfs_open_driver("scsi", "sd");
